...
#if defined(DAF_OS_WINDOWS) && ! defined(__WINE__)
...
#ifdef DAF_JACK_STANDALONE_SKIP_RTAUDIO_FALLBACK
# undef HAVE_RTAUDIO
#endif

#ifdef DAF_JACK_STANDALONE_SKIP_SDL2_FALLBACK
# undef HAVE_SDL2
#endif

#if defined(HAVE_RTAUDIO) && (DAF_PLUGIN_NUM_INPUTS + DAF_PLUGIN_NUM_OUTPUTS) > 0
...
#if defined(HAVE_SDL2) && (DAF_PLUGIN_NUM_INPUTS + DAF_PLUGIN_NUM_OUTPUTS) > 0
...
struct JackBridge {
         ...
         #endif
    {
        ...
        static constexpr const char* const filenames[] = {
           ...
           #elif defined(DAF_OS_WINDOWS) && defined(_WIN64)
            "libjack64.dll",
    ...
    DAF_DECLARE_NON_COPYABLE(JackBridge);
};
...
struct WineBridge {
    ...
    DAF_DECLARE_NON_COPYABLE(WineBridge);
};
...
bool jackbridge_is_ok() noexcept
{
    ...
    return false;
#elif defined(JACKBRIDGE_DIRECT) || defined(DAF_OS_WASM) || defined(RTAUDIO_API_TYPE)
    return true;
#else
