...
struct WebBridge : NativeBridge {
    ...
    bool open(const char*) override
    {
        ...
        }, DAF_PLUGIN_NUM_INPUTS, DAF_PLUGIN_NUM_INPUTS_2, DAF_PLUGIN_NUM_OUTPUTS_2, bufferSize, audioBufferStorage, WebAudioCallback, this);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(DAF_PLUGIN_NUM_INPUTS > 0, false);
    ...
    bool requestBufferSizeChange(const uint32_t newBufferSize) override
    {
        ...
        bool success = EM_ASM_INT({
            ...
            return 1;
        }, DAF_PLUGIN_NUM_INPUTS_2, DAF_PLUGIN_NUM_OUTPUTS_2, newBufferSize) != 0;
    ...
    bool requestMIDI() override
    {
        ...
        if (midiAvailable)
        {
            ...
            }, DAF_PLUGIN_WANT_MIDI_INPUT, DAF_PLUGIN_WANT_MIDI_OUTPUT, kMaxMIDIInputMessageSize, WebMIDICallback, this);
    ...
    static void WebAudioCallback(void* const userData /* , const double timestamp */)
    {
        ...
        else
        {
            for (uint i=0; i<DAF_PLUGIN_NUM_OUTPUTS_2; ++i)
                std::memset(self->audioBuffers[DAF_PLUGIN_NUM_INPUTS + i], 0, sizeof(float)*numFrames);
        }
    }
    ...
    {
        DAF_SAFE_ASSERT_RETURN(len > 0 && len <= (int)kMaxMIDIInputMessageSize,);
