                       ...
                       const char* const license)
{
    ...
    outputFile << "    <string>" DAF_PLUGIN_CLAP_ID "</string>\n";
    ...
    outputFile << "        <string>" STRINGIFY(DAF_PLUGIN_AU_TYPE) "</string>\n";
    outputFile << "        <key>subtype</key>\n";
    outputFile << "        <string>" STRINGIFY(DAF_PLUGIN_UNIQUE_ID) "</string>\n";
    outputFile << "        <key>manufacturer</key>\n";
    outputFile << "        <string>" STRINGIFY(DAF_PLUGIN_BRAND_ID) "</string>\n";
