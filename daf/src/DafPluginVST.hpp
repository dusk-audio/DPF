...
#ifndef DAF_PLUGIN_VST_HPP_INCLUDED
#define DAF_PLUGIN_VST_HPP_INCLUDED

#include "DafPluginChecks.h"
...
#if DAF_PLUGIN_HAS_UI == 1 && DAF_PLUGIN_WANT_DIRECT_ACCESS == 0
# define DAF_VST3_USES_SEPARATE_CONTROLLER 1
#else
# define DAF_VST3_USES_SEPARATE_CONTROLLER 0
#endif

// --------------------------------------------------------------------------------------------------------------------

#if defined(DAF_PROPER_CPP11_SUPPORT) || defined(DAF_OS_MAC)
# include <atomic>
#else
...
#if DAF_VST3_USES_SEPARATE_CONTROLLER || DAF_PLUGIN_WANT_LATENCY || DAF_PLUGIN_WANT_PROGRAMS || DAF_PLUGIN_WANT_MIDI_INPUT
# define DAF_VST3_HAS_INTERNAL_PARAMETERS 1
#else
# define DAF_VST3_HAS_INTERNAL_PARAMETERS 0
#endif

#if DAF_VST3_HAS_INTERNAL_PARAMETERS && DAF_PLUGIN_WANT_MIDI_INPUT && \
    !(DAF_VST3_USES_SEPARATE_CONTROLLER || DAF_PLUGIN_WANT_LATENCY || DAF_PLUGIN_WANT_PROGRAMS)
# define DAF_VST3_PURE_MIDI_INTERNAL_PARAMETERS 1
#else
# define DAF_VST3_PURE_MIDI_INTERNAL_PARAMETERS 0
#endif
...
void snprintf_utf16_t(int16_t* const dst, const T value, const char* const format, const size_t size)
{
    ...
    DAF_SAFE_ASSERT_RETURN(tmpbuf != nullptr,);
...
#if DAF_PLUGIN_HAS_UI
// --------------------------------------------------------------------------------------------------------------------
// translate a vstgui-based key character and code to matching values used by DAF
...
struct ScopedUTF16String {
        ...
        : str(nullptr)
    {
        ...
        DAF_SAFE_ASSERT_RETURN(str != nullptr,);
...
#endif // DAF_PLUGIN_VST_HPP_INCLUDED
