...
#ifdef DAF_WEB_VIEW_INCLUDE_IMPLEMENTATION
...
WebView* webview_choc_create(const WEB_VIEW_NAMESPACE::WebViewOptions& opts)
{
    ...
    DAF_SAFE_ASSERT_RETURN(webview->loadedOK(), nullptr);
...
#endif // DAF_WEB_VIEW_INCLUDE_IMPLEMENTATION
