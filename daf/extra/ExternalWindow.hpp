...
#ifndef DAF_EXTERNAL_WINDOW_HPP_INCLUDED
#define DAF_EXTERNAL_WINDOW_HPP_INCLUDED
...
/**
   ...
   Being compatible with TopLevelWidget/Window, it allows to be used as DAF UI target.

   It can be used to embed non-DAF things or to run a tool in a new process as the "UI".
   ...
   External windows can be setup to run in 3 different modes:
     * Embed:
        ...
        Requires DAF_PLUGIN_HAS_EMBED_UI to be set to 1.
     ...
     * Standalone:
        ...
        DAF will keep calling isRunning() to check if it should keep the event-loop running.
...
public:
   ...
   /**
      Constructor for DAF internal use.
    */
   ...
   /**
      ...
      @note Only available to override if DAF_PLUGIN_HAS_EMBED_UI is set to 1.
    */
    ...
    */
    ...
    {
        DAF_SAFE_ASSERT_UINT_RETURN(width > 1, width,);
        DAF_SAFE_ASSERT_UINT_RETURN(height > 1, height,);
    ...
    */
    ...
    {
        DAF_SAFE_ASSERT_UINT_RETURN(minimumWidth > 0, minimumWidth,);
        DAF_SAFE_ASSERT_UINT_RETURN(minimumHeight > 0, minimumHeight,);
...
private:
    ...
    DAF_DECLARE_NON_COPYABLE(ExternalWindow)
};
...
#endif // DAF_EXTERNAL_WINDOW_HPP_INCLUDED
