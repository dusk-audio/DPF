...
#ifndef DAF_STRING_HPP_INCLUDED
#define DAF_STRING_HPP_INCLUDED
...
public:
    ...
    ~String() noexcept
    {
        DAF_SAFE_ASSERT_RETURN(fBuffer != nullptr,);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(strBuf != nullptr, false);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(pos < fBufferLen, false);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(c != '\0', false);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(prefix != nullptr, false);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(suffix != nullptr, false);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(before != '\0' /* && after != '\0' */, *this);
    ...
    {
        DAF_SAFE_ASSERT_RETURN(c != '\0', *this);
    ...
    static String asBase64(const void* const data, const size_t dataSize)
    {
        ...
        DAF_SAFE_ASSERT_RETURN(strBuf != nullptr, String());
    ...
    String& urlEncode() noexcept
    {
        ...
        DAF_SAFE_ASSERT_RETURN(newbuf != nullptr, *this);
    ...
    String& urlDecode() noexcept
    {
        ...
        for (size_t i=0; i < fBufferLen; ++i)
        {
            ...
            if (c == '%')
            {
                DAF_SAFE_ASSERT_CONTINUE(fBufferLen > i + 2);
    ...
    String operator+(const char* const strBuf) noexcept
    {
        ...
        DAF_SAFE_ASSERT_RETURN(newBuf != nullptr, String());
...
private:
    ...
    void _dup(const char* const strBuf, const size_t size = 0) noexcept
    {
        ...
        {
            DAF_SAFE_ASSERT_UINT(size == 0, static_cast<uint>(size));

            // don't recreate null string
            if (! fBufferAlloc)
                return;

            DAF_SAFE_ASSERT(fBuffer != nullptr);
            std::free(fBuffer);
