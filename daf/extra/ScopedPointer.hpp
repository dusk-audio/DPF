...
#ifndef DAF_SCOPED_POINTER_HPP_INCLUDED
#define DAF_SCOPED_POINTER_HPP_INCLUDED
...
public:
    ...
    */
    ScopedPointer& operator=(ScopedPointer& objectToTransferFrom)
    {
        if (this != objectToTransferFrom.getAddress())
        {
            ...
            DAF_SAFE_ASSERT_RETURN(object == nullptr || object != objectToTransferFrom.object, *this);
    ...
    */
    void swapWith(ScopedPointer<ObjectType>& other) noexcept
    {
        // Two ScopedPointers should never be able to refer to the same object - if
        // this happens, you must have done something dodgy!
        DAF_SAFE_ASSERT_RETURN(object != other.object || this == other.getAddress() || object == nullptr,);
...
#endif // DAF_SCOPED_POINTER_HPP_INCLUDED
