...
#ifndef DAF_LIBRARY_UTILS_HPP_INCLUDED
#define DAF_LIBRARY_UTILS_HPP_INCLUDED
...
{
    DAF_SAFE_ASSERT_RETURN(filename != nullptr && filename[0] != '\0', nullptr);
...
#endif
    } DAF_SAFE_EXCEPTION_RETURN("lib_open", nullptr);
}
...
{
    DAF_SAFE_ASSERT_RETURN(lib != nullptr, false);
...
#endif
    } DAF_SAFE_EXCEPTION_RETURN("lib_close", false);
}
...
{
    DAF_SAFE_ASSERT_RETURN(lib != nullptr, nullptr);
    DAF_SAFE_ASSERT_RETURN(symbol != nullptr && symbol[0] != '\0', nullptr);
...
#endif
    } DAF_SAFE_EXCEPTION_RETURN("lib_symbol", nullptr);
}
...
#endif // DAF_LIBRARY_UTILS_HPP_INCLUDED
