...
#ifndef DAF_SCOPED_SAFE_LOCALE_HPP_INCLUDED
#define DAF_SCOPED_SAFE_LOCALE_HPP_INCLUDED

#include "../DafUtils.hpp"

#include <clocale>

#if ! (defined(DAF_OS_HAIKU) || defined(DAF_OS_MAC) || defined(DAF_OS_WINDOWS))
# define DAF_USE_NEWLOCALE
#endif

#if defined(DAF_OS_WINDOWS) && __MINGW64_VERSION_MAJOR >= 5
# define DAF_USE_CONFIGTHREADLOCALE
#endif
...
private:
#ifdef DAF_USE_NEWLOCALE
    locale_t newloc, oldloc;
#else
# ifdef DAF_USE_CONFIGTHREADLOCALE
    const int oldthreadloc;
# endif
    char* const oldloc;
#endif

    DAF_DECLARE_NON_COPYABLE(ScopedSafeLocale)
...
# endif
#endif // DAF_USE_NEWLOCALE
}

// -----------------------------------------------------------------------

#undef DAF_USE_CONFIGTHREADLOCALE
#undef DAF_USE_NEWLOCALE

END_NAMESPACE_DAF

#endif // DAF_SCOPED_SAFE_LOCALE_HPP_INCLUDED
