...
#if !defined(DGL_USE_FILE_BROWSER) && defined(DAF_UI_FILE_BROWSER) && DAF_UI_FILE_BROWSER == 0
# error To use File Browser in DAF plugins please set DAF_UI_FILE_BROWSER to 1
#endif
