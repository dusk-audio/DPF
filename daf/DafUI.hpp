...
#ifndef DAF_UI_HPP_INCLUDED
#define DAF_UI_HPP_INCLUDED
...
#if DAF_UI_USE_CUSTOM
# include DAF_UI_CUSTOM_INCLUDE_PATH
typedef DAF_UI_CUSTOM_WIDGET_TYPE UIWidget;
#elif DAF_UI_USE_CAIRO
# include "../dgl/Cairo.hpp"
typedef DGL_NAMESPACE::CairoTopLevelWidget UIWidget;
#elif DAF_UI_USE_NANOVG
...
/**
   DAF UI class from where UI instances are created.
...
public:
   /**
      ...
      When @a automaticallyScale is set to true, DAF will automatically scale up the UI
   ...
   /**
      ...
      This will use the native host file browser if available, otherwise a DAF built-in file browser is used.@n
   ...
   /**
      ...
      The @a DAF_NAMESPACE::FileBrowserOptions::className variable is automatically set in this call.
    ...
    */
    bool openFileBrowser(const DAF_NAMESPACE::FileBrowserOptions& options = FileBrowserOptions());
#endif
...
private:
   ...
   /** @internal */
    ...
    DAF_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(UI)
};
