...
#define DAF_DETAILS_HPP_INCLUDED
...
/** It was a typo, sorry.. */
DAF_DEPRECATED_BY("kParameterIsAutomatable")
...
/**
   ...
   @note Only officially supported under LV2. For other formats DAF simulates the behaviour.
*/
...
/**
   ...
   These are static, hard-coded definitions to ensure consistency across DAF and plugins.
*/
namespace ParameterDesignationSymbols {
   /**
     Bypass designation symbol.
    */
   static constexpr const char bypass[] = "daf_bypass";

   /**
     Reset designation symbol.
    */
   static constexpr const char reset[] = "daf_reset";
...
struct ParameterEnumerationValues {
    ...
    */
    ...
    DAF_DECLARE_NON_COPYABLE(ParameterEnumerationValues)
};
...
struct Parameter {
    ...
    */
    ...
    Parameter& operator=(const Parameter& other) noexcept
    {
         ...
         // make sure to not delete data twice
         DAF_SAFE_ASSERT_RETURN(other.enumValues.values == nullptr || !other.enumValues.deleteLater, *this);
...
/**
   ...
   In DAF states refer to key:value string pairs, used to store arbitrary non-parameter data.@n
...
#endif // DAF_DETAILS_HPP_INCLUDED
