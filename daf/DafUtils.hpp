...
#ifndef DAF_UTILS_HPP_INCLUDED
#define DAF_UTILS_HPP_INCLUDED
...
#if defined(DAF_OS_WINDOWS) && defined(_MSC_VER)
#include <basetsd.h>
typedef SSIZE_T ssize_t;
#endif

#if ! defined(CARLA_MATH_UTILS_HPP_INCLUDED) && ! defined(DAF_PROPER_CPP11_SUPPORT) && ! defined(DAF_OS_MAC)
namespace std {
...
{
    if (std::getenv("DAF_CAPTURE_CONSOLE_OUTPUT") == nullptr)
        return fallback;
...
{
    DAF_SAFE_ASSERT_RETURN(size > 0, 0);
...
#ifndef DONT_SET_USING_DAF_NAMESPACE
/**
   If your code uses a lot of DAF classes, then this will obviously save you a lot of typing,
   but can be disabled by setting DONT_SET_USING_DAF_NAMESPACE.
 */
namespace DAF_NAMESPACE {}
using namespace DAF_NAMESPACE;
#endif

#endif // DAF_UTILS_HPP_INCLUDED
