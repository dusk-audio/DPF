...
#define stbtt_fontinfo daf_nvg_stbtt_fontinfo
#define stbrp_context daf_nvg_stbrp_context
#define stbrp_rect daf_nvg_stbrp_rect
#define stbrp_node daf_nvg_stbrp_node
#define stbrp_coord daf_nvg_stbrp_coord
#include "fontstash.h"

#ifndef NVG_NO_STB
#define STB_IMAGE_IMPLEMENTATION
#define stbi_convert_iphone_png_to_rgb daf_stbi_convert_iphone_png_to_rgb
#define stbi_failure_reason daf_stbi_failure_reason
#define stbi_hdr_to_ldr_gamma daf_stbi_hdr_to_ldr_gamma
#define stbi_hdr_to_ldr_scale daf_stbi_hdr_to_ldr_scale
#define stbi_image_free daf_stbi_image_free
#define stbi_info daf_stbi_info
#define stbi_info_from_callbacks daf_stbi_info_from_callbacks
#define stbi_info_from_file daf_stbi_info_from_file
#define stbi_info_from_memory daf_stbi_info_from_memory
#define stbi_is_hdr daf_stbi_is_hdr
#define stbi_is_hdr_from_callbacks daf_stbi_is_hdr_from_callbacks
#define stbi_is_hdr_from_file daf_stbi_is_hdr_from_file
#define stbi_is_hdr_from_memory daf_stbi_is_hdr_from_memory
#define stbi_ldr_to_hdr_gamma daf_stbi_ldr_to_hdr_gamma
#define stbi_ldr_to_hdr_scale daf_stbi_ldr_to_hdr_scale
#define stbi_load daf_stbi_load
#define stbi_load_from_callbacks daf_stbi_load_from_callbacks
#define stbi_load_from_file daf_stbi_load_from_file
#define stbi_load_from_memory daf_stbi_load_from_memory
#define stbi_loadf daf_stbi_loadf
#define stbi_loadf_from_callbacks daf_stbi_loadf_from_callbacks
#define stbi_loadf_from_file daf_stbi_loadf_from_file
#define stbi_loadf_from_memory daf_stbi_loadf_from_memory
#define stbi_set_flip_vertically_on_load daf_stbi_set_flip_vertically_on_load
#define stbi_set_unpremultiply_on_load daf_stbi_set_unpremultiply_on_load
#define stbi_zlib_decode_buffer daf_stbi_zlib_decode_buffer
#define stbi_zlib_decode_malloc daf_stbi_zlib_decode_malloc
#define stbi_zlib_decode_malloc_guesssize daf_stbi_zlib_decode_malloc_guesssize
#define stbi_zlib_decode_malloc_guesssize_headerflag daf_stbi_zlib_decode_malloc_guesssize_headerflag
#define stbi_zlib_decode_noheader_buffer daf_stbi_zlib_decode_noheader_buffer
#define stbi_zlib_decode_noheader_malloc daf_stbi_zlib_decode_noheader_malloc
#include "stb_image.h"
#endif
