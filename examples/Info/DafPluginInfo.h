...
#define DAF_PLUGIN_NAME    "Info"
#define DAF_PLUGIN_URI     "http://distrho.sf.net/examples/Info"
#define DAF_PLUGIN_CLAP_ID "studio.kx.daf.examples.info"

#define DAF_PLUGIN_BRAND_ID  Dstr
#define DAF_PLUGIN_UNIQUE_ID dNfo

#define DAF_PLUGIN_HAS_UI       1
#define DAF_PLUGIN_IS_RT_SAFE   1
#define DAF_PLUGIN_NUM_INPUTS   2
#define DAF_PLUGIN_NUM_OUTPUTS  2
#define DAF_PLUGIN_USES_MODGUI  1
#define DAF_PLUGIN_WANT_TIMEPOS 1
#define DAF_UI_DEFAULT_WIDTH    405
#define DAF_UI_DEFAULT_HEIGHT   256
