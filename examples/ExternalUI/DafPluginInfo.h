...
#define DAF_PLUGIN_NAME  "ExternalUI"
#define DAF_PLUGIN_URI   "http://distrho.sf.net/examples/ExternalUI"
#define DAF_PLUGIN_CLAP_ID "studio.kx.daf.examples.external-ui"

#define DAF_PLUGIN_HAS_UI          1
#define DAF_PLUGIN_HAS_EMBED_UI    1
#define DAF_PLUGIN_HAS_EXTERNAL_UI 1
