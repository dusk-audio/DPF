...
This example will show how to use an external / remote UI together with DAF.<br/>
...
Note that everything regarding external UIs is still a bit experimental in DAF.<br/>
