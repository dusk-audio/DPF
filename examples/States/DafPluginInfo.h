...
#define DAF_PLUGIN_NAME    "States"
#define DAF_PLUGIN_URI     "http://distrho.sf.net/examples/States"
#define DAF_PLUGIN_CLAP_ID "studio.kx.daf.examples.states"

#define DAF_PLUGIN_BRAND_ID  Dstr
#define DAF_PLUGIN_UNIQUE_ID dSts
