...
#define DAF_PLUGIN_NAME    "Web Meters"
#define DAF_PLUGIN_URI     "http://distrho.sf.net/examples/WebMeters"
#define DAF_PLUGIN_CLAP_ID "studio.kx.daf.examples.webmeters"

#define DAF_PLUGIN_BRAND_ID  Dstr
#define DAF_PLUGIN_UNIQUE_ID wMtr
...
#define DAF_UI_USE_WEB_VIEW    1

#define METER_COLOR_GREEN 0
#define METER_COLOR_BLUE  1

#define DAF_UI_DEFAULT_WIDTH 100
#define DAF_UI_DEFAULT_HEIGHT 500
