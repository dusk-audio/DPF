...
/**
  Plugin that demonstrates MIDI output in DAF.
 */
...
protected:
    ...
    */
    ...
    {
        return "Plugin that demonstrates MIDI output in DAF.";
    }
...
private:
    ...
    */
    DAF_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MidiThroughExamplePlugin)
};
