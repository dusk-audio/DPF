...
#define DAF_PLUGIN_NAME    "Meters"
#define DAF_PLUGIN_URI     "http://distrho.sf.net/examples/Meters"
#define DAF_PLUGIN_CLAP_ID "studio.kx.daf.examples.meters"

#define DAF_PLUGIN_BRAND_ID  Dstr
#define DAF_PLUGIN_UNIQUE_ID dMtr
