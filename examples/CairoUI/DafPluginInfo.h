 ...
 */
#define DAF_PLUGIN_NAME "CairoUI"
...
/**
   ...
   @note This macro is required.
 */
#define DAF_PLUGIN_URI "http://distrho.sf.net/examples/CairoUI"
 ...
 */
// #define DAF_PLUGIN_WANT_MIDI_INPUT 0
...
/**
   ...
   When enabled, the macros DAF_UI_CUSTOM_INCLUDE_PATH and DAF_UI_CUSTOM_WIDGET_TYPE are required.
 */
 ...
 */
#define DAF_UI_DEFAULT_WIDTH 200
 ...
 */
#define DAF_UI_DEFAULT_HEIGHT 200
 ...
 */
#define DAF_PLUGIN_UNIQUE_ID dCai
 ...
 */
#define DAF_PLUGIN_LV2_CATEGORY "lv2:UtilityPlugin"
...
/**
   ...
   And extra categories possible for any plugin type:
      ...
      - Stereo
 */
#define DAF_PLUGIN_VST3_CATEGORIES "Fx|Tools|Mono"
...
/**
   ...
   And finally the following audio capabilities can be set:
      ...
      - ambisonic
*/
#define DAF_PLUGIN_CLAP_FEATURES "audio-effect", "utility", "mono"

/**
   The plugin id when exporting in CLAP format, in reverse URI form.
   @note This macro is required when building CLAP plugins
*/
#define DAF_PLUGIN_CLAP_ID "studio.kx.daf.examples.cairo-ui"
