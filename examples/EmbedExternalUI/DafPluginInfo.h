...
#define DAF_PLUGIN_NAME  "EmbedExternalUI"
#define DAF_PLUGIN_URI   "http://distrho.sf.net/examples/EmbedExternalUI"
#define DAF_PLUGIN_CLAP_ID "studio.kx.daf.examples.embed-external-ui"
...
#define DAF_UI_USE_EXTERNAL        1
#define DAF_UI_USER_RESIZABLE      1
#define DAF_UI_DEFAULT_WIDTH       768
